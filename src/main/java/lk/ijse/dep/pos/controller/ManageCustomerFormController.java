...
public class ManageCustomerFormController implements Initializable {
    private CustomerBO customerbo = AppInitializer.getAnnotationConfigApplicationContext().getBean(CustomerBO.class);
    @FXML
    ...
    private void btnSave_OnAction(ActionEvent event) {
        ...
        if (btnSave.getText().equals("Save")) {
            try {
                ...
                new Alert(Alert.AlertType.ERROR, "Successfully save the customer",ButtonType.OK).show();
            } catch (Exception e) {
                e.printStackTrace();
                new Alert(Alert.AlertType.ERROR, "Fail to save the customer",ButtonType.OK).show();
            }
            ...
            try {
              customerbo.updateCustomer(txtCustomerName.getText(), txtCustomerAddress.getText(), selectedItem.getId());
                new Alert(Alert.AlertType.ERROR, "Successfully update the customer",ButtonType.OK).show();
            } catch (Exception e) {
                e.printStackTrace();
        ...
        if (buttonType.get() == ButtonType.YES) {
            ...
            try {
               customerbo.deleteCustomer(selectedItem.getId());
                new Alert(Alert.AlertType.ERROR, "Successfully delete the customer",ButtonType.OK).show();
