...
public class PlaceOrderFormController {
    ...
    private ItemBO itemBO = AppInitializer.getAnnotationConfigApplicationContext().getBean(ItemBO.class);
    private OrderBO orderBO = AppInitializer.getAnnotationConfigApplicationContext().getBean(OrderBO.class);
